...
<div style="padding:2rem 2.5rem 3rem;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:2rem;">
        <div>
            <div style="font-family:'Manrope',sans-serif;font-size:1.6rem;font-weight:800;color:#e2e8ff;letter-spacing:-0.02em;">
                Auction Dashboard
            </div>
            <div style="font-size:0.78rem;color:#8d90a2;margin-top:0.25rem;">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1.25rem;margin-bottom:2rem;">
        ...
        {{-- Active Auctions --}}
        <div style="background:#131b2e;border:1px solid rgba(67,70,86,0.25);border-radius:1rem;padding:1.4rem 1.6rem;position:relative;overflow:hidden;">
            ...
            <div style="display:flex;align-items:center;gap:0.6rem;margin-bottom:0.9rem;">
                <div style="width:36px;height:36px;border-radius:0.6rem;background:rgba(217,119,6,0.15);display:flex;align-items:center;justify-content:center;">
                    <span class="material-symbols-outlined" style="font-size:20px;color:#d97706;">gavel</span>
                </div>
                <span style="font-size:0.72rem;font-weight:600;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;">Active Auctions</span>
            </div>
            <div style="font-family:'Manrope',sans-serif;font-size:2.1rem;font-weight:800;color:#fcd34d;line-height:1;">
                {{ $activeAuctions }}
            </div>
            <div style="font-size:0.7rem;color:#d97706;margin-top:0.4rem;font-weight:600;">
                <span class="material-symbols-outlined" style="font-size:13px;vertical-align:-2px;">radio_button_checked</span>
                Live now
            </div>
        </div>
        ...
        <div style="background:#131b2e;border:1px solid rgba(67,70,86,0.25);border-radius:1rem;padding:1.4rem 1.6rem;position:relative;overflow:hidden;">
            ...
            <div style="display:flex;align-items:center;gap:0.6rem;margin-bottom:0.9rem;">
                <div style="width:36px;height:36px;border-radius:0.6rem;background:rgba(99,102,241,0.15);display:flex;align-items:center;justify-content:center;">
                    <span class="material-symbols-outlined" style="font-size:20px;color:#818cf8;">storefront</span>
                </div>
                <span style="font-size:0.72rem;font-weight:600;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;">Total Auctions</span>
            </div>
            <div style="font-family:'Manrope',sans-serif;font-size:2.1rem;font-weight:800;color:#b6c4ff;line-height:1;">
                {{ $totalAuctions }}
            </div>
        ...
        <div style="background:#131b2e;border:1px solid rgba(67,70,86,0.25);border-radius:1rem;padding:1.4rem 1.6rem;position:relative;overflow:hidden;">
            ...
            <div style="display:flex;align-items:center;gap:0.6rem;margin-bottom:0.9rem;">
                <div style="width:36px;height:36px;border-radius:0.6rem;background:rgba(168,85,247,0.15);display:flex;align-items:center;justify-content:center;">
                    <span class="material-symbols-outlined" style="font-size:20px;color:#c084fc;">trending_up</span>
                </div>
                <span style="font-size:0.72rem;font-weight:600;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;">Total Bids</span>
            </div>
            <div style="font-family:'Manrope',sans-serif;font-size:2.1rem;font-weight:800;color:#c084fc;line-height:1;">
                {{ $totalBids }}
            </div>
        ...
        <div style="background:#131b2e;border:1px solid rgba(67,70,86,0.25);border-radius:1rem;padding:1.4rem 1.6rem;position:relative;overflow:hidden;">
            ...
            <div style="display:flex;align-items:center;gap:0.6rem;margin-bottom:0.9rem;">
                <div style="width:36px;height:36px;border-radius:0.6rem;background:rgba(34,197,94,0.15);display:flex;align-items:center;justify-content:center;">
                    <span class="material-symbols-outlined" style="font-size:20px;color:#4ade80;">category</span>
                </div>
                <span style="font-size:0.72rem;font-weight:600;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;">Categories</span>
            </div>
            <div style="font-family:'Manrope',sans-serif;font-size:2.1rem;font-weight:800;color:#4ade80;line-height:1;">
                {{ $categories->count() }}
            </div>
    ...
    {{-- ────────────────────────── CATEGORIES ROW ────────────────────────── --}}
    @if($categories->count())
    <div style="background:#131b2e;border:1px solid rgba(67,70,86,0.25);border-radius:1rem;padding:1.4rem 1.6rem;margin-bottom:2rem;">
        <div style="font-family:'Manrope',sans-serif;font-size:0.78rem;font-weight:700;color:#8d90a2;text-transform:uppercase;letter-spacing:0.12em;margin-bottom:1rem;">
            Auction Categories
        </div>
        <div style="display:flex;flex-wrap:wrap;gap:0.6rem;">
            ...
            <div style="display:inline-flex;align-items:center;gap:0.4rem;padding:0.35rem 0.85rem;border-radius:9999px;background:rgba(217,119,6,0.1);border:1px solid rgba(217,119,6,0.25);">
                <span style="font-size:0.75rem;font-weight:600;color:#fcd34d;font-family:'Manrope',sans-serif;">{{ $cat->name }}</span>
    ...
    <div style="background:#131b2e;border:1px solid rgba(67,70,86,0.25);border-radius:1rem;margin-bottom:2rem;overflow:hidden;">
        <div style="padding:1.4rem 1.6rem;border-bottom:1px solid rgba(67,70,86,0.2);display:flex;align-items:center;justify-content:space-between;">
            <div style="font-family:'Manrope',sans-serif;font-size:0.85rem;font-weight:700;color:#dae2fd;">Recent Auctions</div>
            ...
            <table style="width:100%;border-collapse:collapse;">
                <thead>
                    <tr style="border-bottom:1px solid rgba(67,70,86,0.2);">
                        <th style="padding:0.85rem 1.6rem;text-align:left;font-size:0.68rem;font-weight:700;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;white-space:nowrap;">Title</th>
                        <th style="padding:0.85rem 1rem;text-align:left;font-size:0.68rem;font-weight:700;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;white-space:nowrap;">Category</th>
                        <th style="padding:0.85rem 1rem;text-align:left;font-size:0.68rem;font-weight:700;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;white-space:nowrap;">Status</th>
                        <th style="padding:0.85rem 1rem;text-align:right;font-size:0.68rem;font-weight:700;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;white-space:nowrap;">Starting</th>
                        <th style="padding:0.85rem 1rem;text-align:right;font-size:0.68rem;font-weight:700;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;white-space:nowrap;">Current</th>
                        <th style="padding:0.85rem 1.6rem 0.85rem 1rem;text-align:left;font-size:0.68rem;font-weight:700;color:#8d90a2;text-transform:uppercase;letter-spacing:0.1em;white-space:nowrap;">Ends At</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr style="border-bottom:1px solid rgba(67,70,86,0.1);transition:background 0.15s;" onmouseover="this.style.background='rgba(217,119,6,0.04)'" onmouseout="this.style.background='transparent'">
                        ...
                        <td style="padding:1rem 1.6rem;">
                            <div style="font-size:0.82rem;font-weight:600;color:#dae2fd;font-family:'Manrope',sans-serif;max-width:220px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">
                                {{ $auction->title }}
                            </div>
                        ...
                        <td style="padding:1rem;text-align:right;">
                            <span style="font-size:0.8rem;font-weight:600;color:#b7c8e1;font-family:'Manrope',sans-serif;">
                        ...
                        {{-- Current Price --}}
                        <td style="padding:1rem;text-align:right;">
                            <span style="font-size:0.8rem;font-weight:700;color:#fcd34d;font-family:'Manrope',sans-serif;">
                        ...
                        <td style="padding:1rem 1.6rem 1rem 1rem;">
                            <span style="font-size:0.75rem;color:#8d90a2;">
        ...
        <div style="padding:3rem 1.6rem;text-align:center;">
            <span class="material-symbols-outlined" style="font-size:40px;color:#374151;display:block;margin-bottom:0.75rem;">gavel</span>
    ...
    <div style="background:#131b2e;border:1px solid rgba(67,70,86,0.25);border-radius:1rem;overflow:hidden;">
        <div style="padding:1.4rem 1.6rem;border-bottom:1px solid rgba(67,70,86,0.2);display:flex;align-items:center;justify-content:space-between;">
            <div>
                <div style="font-family:'Manrope',sans-serif;font-size:0.85rem;font-weight:700;color:#dae2fd;">AgriTech Intelligence Suite</div>
                <div style="font-size:0.7rem;color:#8d90a2;margin-top:0.15rem;">9 smart farming modules — full integration roadmap</div>
            </div>
        ...
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:rgba(67,70,86,0.15);">
            ...
            <div style="background:#131b2e;padding:1.25rem 1.4rem;display:flex;align-items:flex-start;gap:0.85rem;">
                <div style="width:38px;height:38px;border-radius:0.65rem;background:rgba(217,119,6,0.1);border:1px solid rgba(217,119,6,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                    <span class="material-symbols-outlined" style="font-size:20px;color:#d97706;">{{ $mod['icon'] }}</span>
                </div>
                <div style="min-width:0;">
                    <div style="font-family:'Manrope',sans-serif;font-size:0.78rem;font-weight:700;color:#dae2fd;margin-bottom:0.2rem;">{{ $mod['title'] }}</div>
                    <div style="font-size:0.68rem;color:#8d90a2;line-height:1.45;">{{ $mod['desc'] }}</div>
